YAML_DT_BOARD_FLAGS:sage-zynqmp = "{BOARD zcu102-rev1.0}"
YAML_KERNEL_VERSION:sage-zynqmp = "wrlinux-cicd-zcu102"
XSCTH_PROC:sage-zynqmp = "psu_cortexa53_0"

DEPENDS += "virtual/kernel"

do_configure:prepend:sage-zynqmp() {
...
do_configure:append:sage-zynqmp() {
